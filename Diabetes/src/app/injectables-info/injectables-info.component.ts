...
@Component({
  selector: 'app-injectables-info',
  templateUrl: './injectables-info.component.html',
  styleUrls: ['./injectables-info.component.css']
})
export class InjectablesInfoComponent implements OnInit {
