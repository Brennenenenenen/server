...
@Component({
  selector: 'app-inhalable-info',
  templateUrl: './inhalable-info.component.html',
  styleUrls: ['./inhalable-info.component.css']
})
export class InhalableInfoComponent implements OnInit {
...
return this.array2;
   ...
   async fetchcart() {
    this.service.getCartbyname(this.pname).subscribe(
      (data: Cart[]) => {
        this.cart = data;
    }
    );
