...
@Component({
  selector: 'app-inj-combo-data',
  templateUrl: './inj-combo-data.component.html',
  styleUrls: ['./inj-combo-data.component.css']
})
export class InjComboDataComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private service: DbdataService) {
    this.route.params.subscribe(params => this.drugs = params.meds + "/" + params.extra);
   }
